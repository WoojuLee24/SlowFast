...
class EndStopDivideConvBottleneckTransform(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(EndStopDivideConvBottleneckTransform, self).__init__()
...
class EndStopDivideBottleneckTransform(nn.Module):
    ...
    def _construct(
        ...
        # Endstopping, 1x3x3, BN, ReLU
        self.e = EndStoppingDivide(dim_inner,
                                   dim_inner,
                                   stride=[1, str3x3, str3x3],
                                   dilation=[1, dilation, dilation],
                                   groups=num_groups)
...
class EndStopDilationBottleneckTransform(nn.Module):
    ...
    def _construct(
        ...
        # Endstopping: 1x3x3, BN, ReLU
        self.e = EndStoppingDilation(dim_inner,
                                     dim_inner,
                                     stride=[1, str3x3, str3x3],
                                     dilation=[1, dilation, dilation],
                                     groups=num_groups)
